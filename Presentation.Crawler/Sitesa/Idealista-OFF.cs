...
{
    public class Idealista : BaseSite
    {
        public Idealista(string url) : base()
        {
            this.Url = url;
        }
        ...
        public override List<Property> Parse(string html)
        {
            ...
            HtmlNodeCollection collection = document.DocumentNode.SelectNodes("//*[@id='main-content']/div[2]/article/div");
            foreach (HtmlNode node in collection)
            {
                ...
                property.Title = node.SelectSingleNode("div/div[2]/a").InnerHtml;
